...
dragStart = details.globalPosition;
  ...
  onDragUpdate (DragUpdateDetails details) {
    if (dragStart != null) {
      ...
      widget.slideUpdateStream.add(new SlideUpdate(UpdateType.dragging,
          slideDirection,
          slidePercent));
  ...
  onDragEnd (DragEndDetails details){
    widget.slideUpdateStream.add(new SlideUpdate(UpdateType.doneDragging,
        SlideDirection.none,
        0.0));
...
class AnimatedPageDragger{
  ...
  AnimatedPageDragger({
    ...
    final slideStartPercent = slidePercent;
    var endSlidePercent;
    var duration;
...
duration = new Duration(
  milliseconds: (slideRemaining / PERCENT_PER_MILLISECOND).round()
    ...
    completionAnimationController = new AnimationController(vsync: vsync,
    duration: duration)

    ..addListener((){

       slidePercent = lerpDouble(slideStartPercent,
        endSlidePercent,
